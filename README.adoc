...
By default npm and bower are installed but you can register additional registries.  These
will override the default registries (as in do not add in an npm or bower section).  You can
also separate out dependencies (setup production vs dev dependencies for instance).
